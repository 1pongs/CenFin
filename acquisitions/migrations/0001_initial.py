    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('product', 'Product'), ('stock_bond', 'Stock/Bond'), ('property', 'Property'), ('insurance', 'Insurance'), ('equipment', 'Equipment'), ('vehicle', 'Vehicle')], default='product', max_length=20)),
                ...
                ('sum_assured_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=14, null=True)),
