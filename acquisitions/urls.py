...
urlpatterns = [
    ...
    # Archived features removed globally: no archived list or repair route
    ...
    path(
        "<int:pk>/edit/",
        views.AcquisitionUpdateView.as_view(),
        name="acquisition-update",
    ),
    path(
        "<int:pk>/delete/",
        views.AcquisitionDeleteView.as_view(),
        name="acquisition-delete",
    ),
    path(
        "<int:pk>/restore/",
        views.AcquisitionRestoreView.as_view(),
        name="acquisition-restore",
    ),
