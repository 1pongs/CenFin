...
from liabilities.views import (
    lender_search as ajax_lender_search,
    lender_create as ajax_lender_create,
)
...
urlpatterns = [
    ...
    path(
        "api/balance/account/<int:pk>/",
        txn_api_views.account_balance,
        name="api_account_balance",
    ),
    path(
        "api/balance/entity/<int:pk>/",
        txn_api_views.entity_balance,
        name="api_entity_balance",
    ),
    ...
    path(
        "api/lenders/search-or-create/",
        lender_search_or_create,
        name="api_lender_search_create",
    ),
    path("api/currencies/", currency_views.api_currencies, name="api_currencies"),
    path(
        "api/issuers/search-or-create/",
        lender_search_or_create,
        name="api_issuer_search_create",
    ),
    ...
    path(
        ...
        currency_views.set_display_currency,
    ...
    path(
        "acquisitions/",
        include(("acquisitions.urls", "acquisitions"), namespace="acquisitions"),
    ),
    path("entities/", include(("entities.urls", "entities"), namespace="entities")),
    path(
        "liabilities/",
        include(("liabilities.urls", "liabilities"), namespace="liabilities"),
    ),
    path("users/", include("users.urls", namespace="users")),
    path(
        "currencies/",
        include(("currencies.urls", "currencies"), namespace="currencies"),
    ),
]
